 ...
 */
package com.skripsi.psi_flock.hash;
 ...
 * </ul>
 *
 * @author David Curtis, dikutip oleh Irvan Hardyanto, 
 * terpaksa disalin kode mentahnya, karena
 * central maven nya sudah tidak update (kelas ini TIDAK ADA di central maven nya)
 * jadi saya TIDAK ADA MAKSUD SAMA SEKALI UNTUK MENJIPLAK, ATAUPUN MENGKLAIM BAHWA KODE INI MILIK SAYA
